...
**Goal:** One re-runnable script, executed on the Proxmox host, that creates an unprivileged Debian container and deploys music-ui into it as a systemd service.
